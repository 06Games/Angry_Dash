...
public class MainGui : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (UnityEngine.Social.localUser.authenticated)
        {
            ...
            if (UnityEngine.Social.localUser.image != null)
            {
                GUI.DrawTexture(imageRect, UnityEngine.Social.localUser.image,
        ...
        if (GUI.Button(buttonRect, buttonLabel))
        {
            if (!UnityEngine.Social.localUser.authenticated)
            {
                ...
                UnityEngine.Social.localUser.Authenticate((bool success) =>
                {
                    ...
                    if (success)
                    {
                        mStatusText = "Welcome " + UnityEngine.Social.localUser.userName;
                    }
                    else {
